...
def main():
    """
    Tests the XGBoost installation by training a simple classifier.
    """
    print("--- XGBoost Installation Test ---")
    ...
    try:
        ...
        # We are using the scikit-learn wrapper for XGBoost, which is a common practice [[2]] [[4]].
        ...
        print("\nSUCCESS: XGBoost is installed and working correctly!")

    except ImportError:
        print("\nERROR: Failed to import the 'xgboost' library.")
